...
namespace HouseRentMgmt.Api.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260709041510_EmailVerificationCode")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HouseRentMgmt.Api.Features.Auth.Entities.EmailVerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("HouseRentMgmt.Api.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
